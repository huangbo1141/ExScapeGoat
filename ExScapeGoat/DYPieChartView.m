...
- (void)setupForInitialization {
    ...
    animation.fromValue = [NSNumber numberWithFloat:0.0f+val];
    animation.toValue = [NSNumber numberWithFloat: 2*M_PI+val];
    animation.duration = 30.0f;
    animation.repeatCount = INFINITY;
    [self.viewForBaselineLayout.layer addAnimation:animation forKey:@"SpinAnimation"];
     */
}

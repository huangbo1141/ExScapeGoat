...
UIColor *QMChatBackgroundColor() {
    ...
    dispatch_once(&onceToken, ^{
        ...
        //color = [UIColor colorWithRed:237.0f/255.0f green:230.0f/255.0f blue:211.0f/255.0f alpha:0.5f];
        //color = [UIColor whiteColor];
        color = [UIColor colorWithRed:220.0f/255.0f green:220.0f/255.0f blue:220.0f/255.0f alpha:0.5f];
    });
...
UIColor *QMChatOutgoingCellColor() {
    ...
    dispatch_once(&onceToken, ^{
        ...
        //color = [UIColor colorWithRed:0.0f/255.0f green:226.0f/255.0f blue:31.0f/255.0f alpha:0.60f];
        color = [UIColor colorWithRed:74.0f/255.0f green:210.0f/255.0f blue:255.0f/255.0f alpha:0.80f];
...
UIColor *QMChatNotificationCellColor() {
    ...
    dispatch_once(&onceToken, ^{
        ...
        color = [UIColor colorWithWhite:0.75 alpha:0.75];
    });

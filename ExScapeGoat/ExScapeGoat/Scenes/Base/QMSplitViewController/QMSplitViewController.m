...
- (BOOL)splitViewController:(UISplitViewController *)__unused splitViewController collapseSecondaryViewController:(UIViewController *)secondaryViewController ontoPrimaryViewController:(UIViewController *)primaryViewController {
    ...
    UINavigationController *primaryNavigationController = nil;
    if ([primaryViewController isKindOfClass:[UITabBarController class]]) {
        primaryNavigationController = [(UITabBarController *)primaryViewController selectedViewController];
    }else if ([primaryViewController isKindOfClass:[UINavigationController class]]) {
        primaryNavigationController = primaryViewController;
    }

...
- (NSAttributedString *)attributedStringForItem:(QBChatMessage *)messageItem {
    ...
    if ([messageItem isNotificatonMessage] || messageItem.isDateDividerMessage) {
        ...
        //textColor = messageItem.senderID == self.senderID ? [UIColor whiteColor] : [UIColor redColor];
...
- (NSAttributedString *)bottomLabelAttributedStringForItem:(QBChatMessage *)messageItem {
    ...
    if (messageItem.senderID == self.senderID) {
        ...
        text = [NSString stringWithFormat:@"%@  %@", text, [self.statusStringBuilder statusFromMessage:messageItem forDialogType:self.chatDialog.type]];
    }
...
- (QMChatCellLayoutModel)collectionView:(QMChatCollectionView *)collectionView layoutModelAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (class == [QMChatOutgoingCell class] ||
        ...
        layoutModel.spaceBetweenTopLabelAndTextView = 5.0f;
        // *** EDITION
        //layoutModel.staticContainerSize = CGSizeMake(400, 40);
    }
...
- (void)collectionView:(QMChatCollectionView *)collectionView configureCell:(UICollectionViewCell *)cell forIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([cell isKindOfClass:[QMChatOutgoingCell class]]
        ...
        currentCell.textView.linkAttributes = @{NSForegroundColorAttributeName : [UIColor whiteColor], NSUnderlineStyleAttributeName : @(YES)};
        
        // *** EDITION
        currentCell.containerView.layer.shadowColor = [UIColor lightGrayColor].CGColor;
        currentCell.containerView.layer.shadowOffset = CGSizeMake(0, 1);
        currentCell.containerView.layer.shadowOpacity = 1;
        currentCell.containerView.layer.shadowRadius = 1.0;
        ...
        //currentCell.containerView.bgColor = [UIColor colorWithRed:78.0 green:203.0 blue:255.0 alpha:1.0];
        currentCell.textView.linkAttributes = @{NSForegroundColorAttributeName : QMChatIncomingLinkColor(), NSUnderlineStyleAttributeName : @(YES)};
        ...
        //avatarView.frame  = CGRectMake(avatarView.frame.origin.x, avatarView.frame.origin.y, 0.0, 0.0);

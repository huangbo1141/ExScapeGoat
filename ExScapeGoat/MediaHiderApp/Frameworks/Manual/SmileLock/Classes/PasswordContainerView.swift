...
open class PasswordContainerView: UIView {
    ...
    //MARK: Init
    open class func initMe(withDigit digit: Int) -> PasswordContainerView {
    ...
    open class func initMe(in stackView: UIStackView, digit: Int) -> PasswordContainerView {
        let passwordContainerView = initMe(withDigit: digit)

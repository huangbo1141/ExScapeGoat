...
- (void)cameraButtonTapped:(id)sender {
    ...
    UIAlertAction* ac1 = [UIAlertAction actionWithTitle:@"Camera" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
    ...
    UIAlertAction* ac2 = [UIAlertAction actionWithTitle:@"Library" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
    ...
    UIAlertAction* ac3 = [UIAlertAction actionWithTitle:@"Newest" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        [CGlobal grantedPermissionCamera:^(BOOL ret) {
            if (ret) {
                [self addNewestPhoto:sender];
            }
        }];
    }];
    
    UIAlertAction* ac4 = [UIAlertAction actionWithTitle:@"Remove" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        [self pictureDetailDeleteAttachment:sender];
    }];
